...
#GFR1_20 = [42.17,54.29,60.04,72.6,66.76,68.71,63.6,53.01,41.68,38.71,
#           27.77,20.63,15.97,11.14,9.34,8.16,5,4.18,2.83,1.6,0.94,1.4,
#           0.81,0.57,0.09,0.59,0.33,0.22,0.2,0.11]
#GFR2_20 = [0.00,10.01,14.51,25.62,28.44,33.77,34.92,31.81,35.9,38.22,	
#           33.23,26.95,24.92,23.22,20.29,16.57,11.09,10.13,5.77,5.72,
#           3.99,2.21,2.94,1.14,1.04,0.73,0.43,0.67,0.51,0.42]
#GFR3_20 = [0.00, 0.00, 0.87,1.89,2.38,3.25,5,5.2,6.45,3.58,6.85,6.68,5.89,
#           6.37,5.35,5.02,2.84,2.66,2.95,1.72,1.05,1.3,1.12,0.76,0.57,0.45,0.65,
#           0.33,0.2,0.11]
...
GFR2_20 =  [0.0, 5.57, 8.86,	14.12,	17.62, 22.102, 26.29, 28.75, 31.85,	31.60,
            30.15, 29.328, 25.73, 20.938, 17.11, 13.13, 9.886, 7.92, 5.864,
            4.31, 3.17, 2.24, 1.46,	1.244, 0.95, 0.85, 0.79,	0.72, 0.62, 0.59]
GFR3_20 =  [0.0, 0.0, 0.81, 1.4,	2.22, 2.59, 3.37, 3.73, 4.138, 4.102, 4.494,	
...
fig00_rps.savefig('rps00_4.0s.png', dpi=100)
